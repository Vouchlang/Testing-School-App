...
public class FoE_Mast_FB_So extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_foe_mast_fb_so);
        getSupportActionBar().setTitle("            Program");
        getSupportActionBar().setDisplayShowHomeEnabled(true);

        BottomNavigationView bottom_nav_foe_mast_fb_so = findViewById(R.id.bottom_nav_foe_mast_fb_so);
        bottom_nav_foe_mast_fb_so.setOnNavigationItemSelectedListener(navListener);
                ...
                public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                    ...
                    switch (item.getItemId()){
                        case R.id.first_semester:
                            selectedFragment = new Fragment_FoE_Mast_FB_So_Fs();
                            break;
                        case R.id.second_semester:
                            selectedFragment = new Fragment_FoE_Mast_FB_So_Ss();
                            break;
                    }
                    getSupportFragmentManager().beginTransaction().replace(R.id.frame_layout_foe_mast_fb_so,
